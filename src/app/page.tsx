      ...
      <section className="bg-white">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-700">Zlepšite svoju hovorenú nemčinu z pohodlia vášho domova. Interaktívne Zoom kurzy, ktoré vás priblížia k plynulosti. Hodiny si organizujete podla seba a svojho volného času.</p>
            ...
            <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 hover:text-gray-900 dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
              Prihlás sa na kurz
            </a>
          </div>
      ...
      <section className="bg-white">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            ...
            <p className="text-gray-500 sm:text-xl dark:text-gray-700">Naše kurzy nemeckého jazyka cez Zoom sú navrhnuté tak, aby vás ponorili priamo do jazyka a kultúry bez toho, aby ste museli opustiť pohodlie svojho domova. S hlavným zameraním na hovorenú nemčinu, naše interaktívne sedenia vám umožnia zlepšiť vaše jazykové zručnosti v reálnom čase, s okamžitou spätnou väzbou od skúsených lektorov. Či už ste úplný začiatočník alebo pokročilý študent, máme pre vás kurz.</p>
          </div>
