...
export const AboutLectorSection = () => {
    return (
        <section className="bg-gradient-to-r from-primary-950 to-blue-500 rounded-xl w-full">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                ...
                <div className="flex gap-8 mb-6 lg:mb-16 justify-center px-4">
                    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 max-w-5xl px-4">
                        <a href="#" className="">
