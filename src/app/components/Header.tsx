                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className={`justify-between items-center w-full lg:flex lg:w-auto lg:order-1 transition-[height] ${isMenuOpen ? "h-auto" : "h-0"}`} id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-gray-900 lg:p-0 dark:text-white" aria-current="page">Kurz nemčiny</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-white  border-b border-gray-100  lg:hover:bg-transparent lg:border-0 lg:hover:text-gray-900 lg:p-0">Cenník</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-white  border-b border-gray-100  lg:hover:bg-transparent lg:border-0 lg:hover:text-gray-900 lg:p-0">Dohodnúť prvú hodinu</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-white  border-gray-100  lg:hover:bg-transparent lg:border-0 lg:hover:text-gray-900 lg:p-0  ">Pre koho sú kurzy určené</a>
                            </li>
