        ...
        <section className="bg-white dark:bg-gray-900 rounded-xl">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    ...
                    <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Toto sú naše odporúčané balíky hodín pre dosiahnutie plynulejšej nemčiny</p>
                </div>
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        ...
                        <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Plánujete žiť v nemecky hovoriacej krajine, pôsobiť v nemeckej firme, pripravujete sa na certifikát z Nemčiny&nbsp;? <br /> Tak Vám odporúčame tento balík hodín s až 5 hodinami zadarmo. </p>
                        <div className="flex justify-center items-baseline my-8 flex-col">
