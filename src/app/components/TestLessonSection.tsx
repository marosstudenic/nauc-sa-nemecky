        ...
        <section className="bg-white my-8">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <p className="mb-6 font-light text-gray-800 md:text-lg">Pre Vás ponúkam <b className="font-extrabold">skúšobnú hodinu </b>. Dohodneš pri prvú hodinu s lektorom, ktorá bude plnohodnotne prebiehať 45 minút a až potom ako si vyskúšaš  samotnú techniku výučby sa môžeš rozhodnúť či chceš v hodinách plnohodnotne pokračovať. </p>
